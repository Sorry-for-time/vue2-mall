        ...
        <div class="loginform">
          ...
          <div class="content">
            ...
            <div class="call clearFix">
              <ul>
                <li><img src="./images/qq.png" alt="图片貌似没有加载成功" /></li>
                <li><img src="./images/sina.png" alt="图片貌似没有加载成功" /></li>
                <li><img src="./images/ali.png" alt="图片貌似没有加载成功" /></li>
                <li><img src="./images/weixin.png" alt="图片貌似没有加载成功" /></li>
              </ul>
